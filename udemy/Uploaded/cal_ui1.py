...
class app:
    def __init__(self):
        ...
        self.results_entry.grid(row=2, column=0, columnspan=2, padx=30, pady=10)
        ...
        self.reset_val.grid(row=5, column=0, columnspan=2, padx=30, pady=10)
